...
public abstract class BasePacketParser2 : IPacketParser
{
    ...
    public BasePacketParser2(bool isAscii = false, IPacketParser? prevPacketParser = null, bool? isReverse = null)
    {
        IsAscii = isAscii;
